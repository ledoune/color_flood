...
*
*	\details \a grid : Grille du jeu
*	\n\a size : Taille de la grille, ie nombre de cases sur un coté
*	\n\a cNb : Nombre de couleurs différentes
*	\n\a turnCount : Nombre de clic au cours de la partie
*	\n\a cTab : Tableau contenant toutes les couleurs
*	\n\a cPlayer : Couleur du joueur, ie couleur de la case en haut à gauche (première case)
*/
...
/**
*	\fn gameOver(game *g)
*	\brief Cherche si la partie est terminée (victoire du joueur) ou si elle continue
*
*	\param g : la grille
