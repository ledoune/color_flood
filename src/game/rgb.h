...
*	\brief Créer une couleur en utilisant les valeurs données de chaque composante
*
*	\param R : composante rouge (max 256)
*	\param G : composante verte (max 256)
*	\param B : composante bleue (max 256)
*	\return : la couleur (en code RGB)
*/
...
/**
*	\fn rgbPrint(RGB c)
*	\brief Affiche les trois composantes de la couleur dans la console
*
*	\param c : une couleur
*/
void rgbPrint(RGB c);
...
*	\brief Affiche un tableau contenant plusieurs couleurs dans la console
*
