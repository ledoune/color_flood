...
*
*	\details \var rgbGrid : tableau contenant les couleurs (en code RGB) des cases de la grille, mises les unes à la suite des autres
*	\n\var ccGrid : tableau contenant la composante connexe (désignée par un entier supérieur ou égal à 1 : "label") à laquelle appartient la case associée
*	\n\var size : taille de la grille, ie nombre de case sur un coté
*	\n\var maxLabel : nombre de composantes connexes
*/
