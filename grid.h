...
typedef struct t_grid {
	RGB* rgbGrid; /*!< tableau contenant les couleurs (en code RGB) des cases de la grille, mises les unes à la suite des autres */
	int* ccGrid; /*!< tableau contenant la composante connexe (désignée par un entier supérieur ou égal à 1 : "label") à laquelle appartient la case associée */
	int size; /*!< taille de la grille, ie nombre de case sur un coté */
	int maxLabel; /*!< nombre de composantes connexes */
} grid;
...
/**
*	\fn gridImport(FILE *fp, int board_size, RGB *cTab, int cNb)
*	\brief Importe une grille à partir d'un fichier existant
*
*	\param fp : le fichier
*	\param board_size : taille de la grille
*	\param cTab : tableau contenant les différentes couleurs
...
/**
*	\fn gridExport(FILE *fp, grid *g, RGB *cTab, int cNb)
*	\brief Exporte une grille dans un fichier
*
*	\param fp : le fichier
*	\param g : la grille
*	\param cTab : tableau contenant les différentes couleurs
...
/**
*	\fn gridEqual(grid* g1, grid* g2)
*	\brief Vérifie si deux grilles sont identiques
*
*	\param g1 : la première grille
*	\param g2 : la deuxième grille
*	\return true si les grilles sont les mêmes, false sinon.
*/
bool gridEqual(grid* g1, grid* g2);

/**
*	\fn gridCopy(grid* g1, grid* g2)
*	\brief Copie une grille
*
*	\param g1 : la grille à copier
*	\param g2 : la grille dans laquelle il faut mettre la copie
*/
